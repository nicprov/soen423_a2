...
public class Parsing {
     ...
     */
    public static String[] getTimeslots(BufferedReader bufferedReader) throws IOException {
        System.out.print("Enter a list of timeslots (ie. 9:30-10:00, 11:15-11:30): ");
        String[] timeslots = Parsing.tryParseTimeslotList(bufferedReader.readLine());
     ...
     */
    public static String[] tryParseTimeslotList(String list){
        String[] tempList = list.split("\\s*,\\s*");
